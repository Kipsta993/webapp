document.addEventListener('DOMContentLoaded', function() {
    ...
    // Инициализация выпадающего меню Other
    initializeOtherMenu();
});
...
function initializeOtherMenu() {
    ...
    if (otherButton && otherMenu) {
        // Открытие/закрытие меню при клике на кнопку Other
        otherButton.addEventListener('click', function(e) {
            ...
            document.addEventListener('click', function closeMenu(e) {
                if (!otherMenu.contains(e.target) && e.target !== otherButton) {
        ...
        const menuItems = otherMenu.querySelectorAll('a');
