    ...
    taskItems.forEach(taskItem => {
        ...
        taskItem.addEventListener('click', function(event) {
            ...
            if (!event.target.matches('input[type="checkbox"]') && 
                ...
                // Добавляем анимацию даже для выполненных заданий при клике на любую часть задания
                else if (checkbox && checkbox.checked && checkbox.disabled && !isAnimating) {
                    // Устанавливаем флаг, что анимация выполняется
                    isAnimating = true;
