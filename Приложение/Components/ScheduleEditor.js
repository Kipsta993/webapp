...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function enterEditMode(scheduleItem, item) {
    ...
    editForm.innerHTML = `
      <input type="text" class="schedule-edit-input" value="${item.title}" placeholder="Название задания">
      <div class="schedule-edit-time">
        <input type="time" class="schedule-edit-start-time" value="${item.startTime}">
        <input type="time" class="schedule-edit-end-time" value="${item.endTime}">
      </div>
