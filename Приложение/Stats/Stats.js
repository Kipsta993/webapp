  ...
  function updateChartData(startDate, endDate) {
    ...
    dayBars.forEach((dayBar, index) => {
      ...
      if (isFutureDay && selectedWeekOffset === 0) {
        ...
        dayBars[index].style.height = '1%'; // Минимальная высота для видимости
        ...
        // Для нулевой активности показываем минимальную высоту
        const height = dayTime > 0 ? Math.min(98, (dayTime / maxTime) * 98) : 1;
