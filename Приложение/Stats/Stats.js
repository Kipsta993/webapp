...
// Функция для обновления значения времени с эффектом
...
function initStatsSlider() {
    ...
    function updateSlider() {
        ...
        slides.forEach((slide, index) => {
            ...
            if (index === currentIndex) {
                ...
                // Удаляем анимацию при переключении слайдов
                // Оставляем только установку видимости
                slide.style.opacity = '1';
                
                // Вызываем функцию для анимации элементов внутри слайда
    ...
    // Удаляем анимацию элементов управления слайдером
