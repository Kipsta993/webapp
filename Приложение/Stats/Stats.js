...
function initStatsSlider() {
    ...
    totalStatsElement.textContent = slides.length;
    ...
    function updateSlider() {
        ...
        // Добавляем классы для предыдущего и следующего слайдов (для анимации)
        if (currentIndex > 0) {
    ...
    function handleSwipe() {
        ...
        statsContainer.addEventListener('touchmove', function(e) {
        ...
        statsContainer.addEventListener('touchend', function(e) {
            ...
            // Если горизонтальный свайп сильнее вертикального и достаточно длинный
