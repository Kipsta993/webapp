...
document.addEventListener('touchend', function() {
    // Сбрасываем все активные состояния элементов настроек
    document.querySelectorAll('.setting-item-active').forEach(item => {
        item.classList.remove('setting-item-active');
        item.style.transform = '';
    });
    
    // Сбрасываем все активные состояния опций тем
    document.querySelectorAll('.theme-option-active').forEach(option => {
        option.classList.remove('theme-option-active');
        option.style.transform = '';
    });
    
    // Сбрасываем все активные состояния кнопок
