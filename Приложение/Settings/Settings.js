document.addEventListener('DOMContentLoaded', function() {
    ...
    // Добавление обработчика для кнопки открытия редактора задач
    const openTaskEditorButton = document.getElementById('open-task-editor');
    if (openTaskEditorButton) {
        openTaskEditorButton.addEventListener('click', function() {
            openTaskEditor();
        });
    }
    
    // Добавление обработчика для плавающей кнопки редактора задач
    const floatingTaskEditorButton = document.getElementById('floating-task-editor-button');
    if (floatingTaskEditorButton) {
...
function applyLightTheme() {
    ...
    // Удаляем класс темной темы, если он есть
...
function applyDarkTheme() {
    ...
    // Добавляем класс темной темы для стилизации компонентов
