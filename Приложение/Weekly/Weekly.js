...
function loadTaskStates() {
    try {
        ...
        const savedStates = JSON.parse(localStorage.getItem('weekly_task_states') || '{}');
        ...
        // Загружаем еженедельные задачи из localStorage, если они есть
...
function saveTaskStates() {
    try {
        ...
        localStorage.setItem('weekly_task_states', JSON.stringify(states));
    } catch (error) {
