...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Функция для открытия модального окна (ВРЕМЕННО ОТКЛЮЧЕНО)
  /*
  function openModal(entry) {
    ...
    const modalPhotos = modal.querySelector('.modal-photos');
  ...
  */
  ...
  // Функция для закрытия модального окна (ВРЕМЕННО ОТКЛЮЧЕНО)
  /*
  function closeModal() {
    if (!modal) return;
  ...
  */
  ...
  // Функция для открытия полноэкранного просмотра фото (ВРЕМЕННО ОТКЛЮЧЕНО)
  /*
  ...
  */
  ...
  // Функция для закрытия полноэкранного просмотра (ВРЕМЕННО ОТКЛЮЧЕНО)
  /*
  ...
  */
  ...
  // Функция для обновления навигации в полноэкранном режиме (ВРЕМЕННО ОТКЛЮЧЕНО)
  /*
  function updateFullscreenNav() {
    ...
    currentPhotos.forEach((_, i) => {
      ...
      dot.className = i === currentPhotoIndex ? 'active' : '';
  ...
  */
  ...
  // Инициализация обработчиков для модальных окон (ВРЕМЕННО ОТКЛЮЧЕНО)
  /*
