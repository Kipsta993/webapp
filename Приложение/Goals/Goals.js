...
function displayGoals(goals) {
    ...
    const quarterlyList = document.querySelector('.goals-section:nth-child(2) .goals-list');
    ...
    goals.forEach(goal => {
        ...
        } else if (goal.type === 'quarterly' && quarterlyList) {
            quarterlyList.appendChild(goalElement);
        }
    });
}
